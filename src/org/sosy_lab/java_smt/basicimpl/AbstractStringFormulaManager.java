...
public abstract class AbstractStringFormulaManager<TFormulaInfo, TType, TEnv, TFuncDecl>
  ...
  protected abstract TFormulaInfo
      substring(TFormulaInfo pString, TFormulaInfo pStart, TFormulaInfo pLength);
  ...
  protected abstract TFormulaInfo
      replace(TFormulaInfo pString, TFormulaInfo pFind, TFormulaInfo pReplace);
  ...
  protected abstract TFormulaInfo
      indexOf(TFormulaInfo pString, TFormulaInfo pSearch, TFormulaInfo pInt);
  ...
  protected abstract TFormulaInfo regexRange(TFormulaInfo pStart, TFormulaInfo pEnd);

  @Override
  public BooleanFormula strInRegex(StringFormula pString, RegexFormula pRegex) {
    return wrapBool(strInRegex(extractInfo(pString), extractInfo(pRegex)));
  }
